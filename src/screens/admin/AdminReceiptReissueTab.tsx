    ...
    <div className="receipt-reissue-wrapper">
      <section className="admin-list-panel admin-list-panel-wide" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', overflow: 'hidden' }}>
        ...
        <div className="receipt-reissue-grid">
          ...
          <div className="receipt-reissue-preview-pane" style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'stretch', height: '100%', minHeight: 0, width: '320px', minWidth: '320px', maxWidth: '320px', boxSizing: 'border-box' }}>
            {loadingDetail && (
            ...
            {!loadingDetail && ticketDetail && (
              <>
                ...
                <div className="receipt-paper" style={{ margin: '12px 24px 12px 8px', flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', boxSizing: 'border-box', overflow: 'hidden' }}>
                  ...
                  {/* 明細行リスト */}
                  <div style={{ flex: 1, padding: '0 20px', overflowY: 'auto', minHeight: 0, boxSizing: 'border-box', width: '100%' }}>
                  ...
                  {/* フッター */}
                  <div style={{ padding: '0 20px 16px', flexShrink: 0, borderTop: '2px dashed #aaa', background: '#fdfdfd', boxSizing: 'border-box', width: '100%' }}>
